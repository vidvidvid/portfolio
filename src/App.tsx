...
import { Github, Linkedin, Mail, ExternalLink, User, Briefcase, Code, MessageSquare } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4">
              <a href="#" className="p-2 bg-gray-900 text-white rounded-full hover:bg-gray-700 transition-colors">
                <Github size={24} />
              </a>
              <a href="#" className="p-2 bg-gray-900 text-white rounded-full hover:bg-gray-700 transition-colors">
                <Linkedin size={24} />
